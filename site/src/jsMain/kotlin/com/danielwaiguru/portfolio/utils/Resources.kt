package com.danielwaiguru.portfolio.utils
...
object Resources {
    ...
    object Image {
        const val PROFILE_PHOTO = "me.png"
    }

    object String {
        const val NAME = "Daniel Waiguru"
        const val PROFESSION = "Android & Kotlin Software Engineer"
        const val ABOUT_ME =
            "Seasoned Software Engineer with hands-on experience designing, developing, and optimizing cutting-edge Android applications. Adept at leading cross-functional teams, solving complex technical challenges, and delivering high-quality software. I am seeking opportunities to leverage my expertise in Android development to create innovative solutions and drive user-centric experiences for leading organizations in the technology industry."
